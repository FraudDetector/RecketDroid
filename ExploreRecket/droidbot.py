...
class DroidBot(object):
    ...
    def __init__(self,
        ...
        if output_dir is not None:
            ...
            html_index_path = pkg_resources.resource_filename("ExploreRecket", "resources/index.html")
            stylesheets_path = pkg_resources.resource_filename("ExploreRecket", "resources/stylesheets")
        ...
        try:
            ...
            # update file current_pkg.txt for the work of network traffic collection
            pkg_path = 'ExploreRecket/output/traffic/current_pkg.txt'
