...
# Add: Baidu OCR Configuration
def get_client():
    APP_ID = 'xxxxxxx'  # Set your app ID
    API_KEY = 'xxxxxxxxxxxxxxxxxxxxxxxxx'  # Set your API Key
    SECRET_KEY = 'xxxxxxxxxxxxxxxxxxxxxxxxx'  # Set your secret key
